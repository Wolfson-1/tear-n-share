...
export default function useSetNewMatch2(user,receivedRequests) {
    ...
    useEffect(() => {  
      ...
      },[addBuddyUser.isComplete,addBuddyRequester.isComplete,updateAdvertRequester.isComplete,updateAdvertUser.isComplete,addAdvertSharedObj.isComplete,addSharedUserData.isComplete])
};
